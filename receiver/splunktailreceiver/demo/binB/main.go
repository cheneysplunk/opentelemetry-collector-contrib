...
// Program splunktcpout-otlp-col is an OpenTelemetry Collector binary.
package main
...
func main() {
	info := component.BuildInfo{
		Command:     "splunktcpout-otlp-col",
		Description: "E2E binary B: OTLP receiver → splunktcpoutexporter",
		Version:     "0.0.1-dev",
	}
